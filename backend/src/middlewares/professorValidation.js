...
// ── Create Professor rules (password required) ────────────────
...
// ── Update Professor rules (password optional) ────────────────
const updateProfessorRules = [
  body('first_name')
    .trim().notEmpty().withMessage('First name is required.')
    .isLength({ min: 2 }).withMessage('First name must be at least 2 characters.'),
...
module.exports = { validate, createProfessorRules, updateProfessorRules };